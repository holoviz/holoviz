...
**1.2 Project Lead**. The Project Lead is a Maintainer that will have the final say on the project direction and management, unless overridden. By default and whenever possible, the Project Lead should defer to the consensus forming process of the Maintainers. Maintainers may override a Project Lead by 3/4 vote. Maintainers may elect or remove a Project Lead by 4/5 vote. During their term, the Project Lead should maintain a high level of involvement in most types of activity with the Project, such as advocacy, planning, support, review, and development. The Project Lead also assumes Lead Maintainer and Release Manager duties by default, if those roles are vacant. A Project Lead may resign at any time. If a Project Lead is unresponsive at their listed handle for more than three months, the Maintainers may vote to remove the member.
