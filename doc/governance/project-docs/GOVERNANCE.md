...
**1.4 Project Director**. The Project Director is a Maintainer that will have the final say on the project direction and management, unless overridden. By default and whenever possible, the Project Director should defer to the consensus forming process of the Maintainers. Maintainers may override a Project Director by 3/4 vote. Maintainers may elect or remove a Project Director by 4/5 vote. During their term, the Project Director should maintain a high level of involvement in most types of activity with the Project, such as advocacy, planning, support, review, and development. The Project Director also assumes Lead Maintainer duties by default, if this role is vacant.
